...
export type Mutation = {
  ...
  updateMealWithExistingDishAndExistingSource?: Maybe<UpdateMealWithExistingDishAndExistingSourcePayload>;
};
...
export type MutationUpdateMealWithExistingDishAndExistingSourceArgs = {
  input: UpdateMealWithExistingDishAndExistingSourceInput;
};
...
/** Autogenerated input type of UpdateMealWithExistingDishAndExistingSource */
export type UpdateMealWithExistingDishAndExistingSourceInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
...
/** Autogenerated return type of UpdateMealWithExistingDishAndExistingSource. */
export type UpdateMealWithExistingDishAndExistingSourcePayload = {
  __typename?: 'UpdateMealWithExistingDishAndExistingSourcePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  mealId: Scalars['Int'];
};
