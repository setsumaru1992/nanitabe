...
export type Mutation = {
  ...
  updateDishWithExistingSource?: Maybe<UpdateDishWithExistingSourcePayload>;
...
export type MutationUpdateDishWithExistingSourceArgs = {
  input: UpdateDishWithExistingSourceInput;
};
...
/** Autogenerated input type of UpdateDishWithExistingSource */
export type UpdateDishWithExistingSourceInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  dish: DishForUpdate;
...
/** Autogenerated return type of UpdateDishWithExistingSource. */
export type UpdateDishWithExistingSourcePayload = {
  __typename?: 'UpdateDishWithExistingSourcePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  dishId: Scalars['Int'];
};
...
export type UpdateDishWithExistingSourceMutationVariables = Exact<{
  dish: DishForUpdate;
  dishSourceRelation?: InputMaybe<DishSourceRelationForUpdate>;
}>;


export type UpdateDishWithExistingSourceMutation = { __typename?: 'Mutation', updateDishWithExistingSource?: { __typename?: 'UpdateDishWithExistingSourcePayload', dishId: number } | null };
...
export const UpdateDishWithExistingSourceDocument = gql`
    mutation updateDishWithExistingSource($dish: DishForUpdate!, $dishSourceRelation: DishSourceRelationForUpdate) {
  updateDishWithExistingSource(
    ...
    `;
export type UpdateDishWithExistingSourceMutationFn = Apollo.MutationFunction<UpdateDishWithExistingSourceMutation, UpdateDishWithExistingSourceMutationVariables>;

/**
 * __useUpdateDishWithExistingSourceMutation__
 *
 * To run a mutation, you first call `useUpdateDishWithExistingSourceMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDishWithExistingSourceMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateDishWithExistingSourceMutation, { data, loading, error }] = useUpdateDishWithExistingSourceMutation({
 *   variables: {
 *      dish: // value for 'dish'
 ...
 * });
 */
export function useUpdateDishWithExistingSourceMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDishWithExistingSourceMutation, UpdateDishWithExistingSourceMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDishWithExistingSourceMutation, UpdateDishWithExistingSourceMutationVariables>(UpdateDishWithExistingSourceDocument, options);
      }
export type UpdateDishWithExistingSourceMutationHookResult = ReturnType<typeof useUpdateDishWithExistingSourceMutation>;
export type UpdateDishWithExistingSourceMutationResult = Apollo.MutationResult<UpdateDishWithExistingSourceMutation>;
export type UpdateDishWithExistingSourceMutationOptions = Apollo.BaseMutationOptions<UpdateDishWithExistingSourceMutation, UpdateDishWithExistingSourceMutationVariables>;
